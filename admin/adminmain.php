              ...
              <div class="row">
                 <div class="col-md-3"style="margin:10px;">
                      ...
                      <div class="col-md-8" style="">
                          ...
                          <div class="col-md-9">
                            <h1> <i class="fa fa-user-circle-o" aria-hidden="true"></i> Dealer <small>View All dealers</small></h1><hr>
                            <ol class="breadcrumb">
                                <li><a href="adminmain.php"><i class="fa fa-tachometer" aria-hidden="true"></i> ADMIN PANEL </a></li>
                              <li class="active"> <i class="fa fa-user-circle-o" aria-hidden="true"></i> Dealer</li>
                            </ol>
                    ...
                    <h6 align="left" style=""> search result... </h1> 
                            ...
                            <?Php
                              if(isset($_POST['search']))
                              {
                                ...
                                $sql = "(SELECT id,nam,parentage,user,pass FROM register
                                where  nam='$search' or  user='$search' or licenceno='$search')";
                         ...
                         <tr>
                                              ...
                                              <td> <a href="delete.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i> </td>
