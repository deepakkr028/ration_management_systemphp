            ...
            <section>
               <div class="row">
                  ...
                  <div class="col-md-8" style="">
                    ...
                    <div class="col-md-9">
                      <h1><i class="fa fa-comment" aria-hidden="true"></i> COMMENTS <small>View All comments</small></h1><hr>
                      <ol class="breadcrumb">
                          <li><a href="adminmain.php"> <i class="fa fa-tachometer" aria-hidden="true"></i> ADMIN PANEL </a></li>
                        <li class="active"> <i class="fa fa-comment" aria-hidden="true"></i> COMMENTS</li>
                      </ol>
                        ...
                        <table class="table table-bordered table-striped table-hover" style="margin-left:auto;"
                              ...
                              <?php
                                $sql = "(SELECT id,nam,email,comments FROM comment)";
                              ...
                              ?>
                                ...
                                <tr>
                                  ...
                                  <td> <a href="deletec.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i>  </td>
