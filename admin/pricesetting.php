            ...
            <section>
                 <div class="row">
                  ...
                  <div class="col-md-8" style="">
                    ...
                    <div class="col-md-9">
                      <h1> <i class="fa fa-eye" aria-hidden="true"></i> <i class="fa fa-usd" aria-hidden="true"></i> VIEW PRICE </h1><hr>
                      <ol class="breadcrumb">
                          <li><a href="adminmain.php"> <i class="fa fa-tachometer" aria-hidden="true"></i> ADMIN PANEL </a></li>
                        <li class="active">  <i class="fa fa-eye" aria-hidden="true"></i> <i class="fa fa-usd" aria-hidden="true"></i> VIEW PRICE </li>
                      </ol>

                        <table class="table table-bordered table-striped table-hover" style="margin-left:auto;"
                                  <tr border=4px;>
                                    <th>Rice Price APL</th>
                                    <th>Rice Price BPL</th>
                                    <th>Sugar Price APL</th>
                                    <th>Sugar Price BPL</th>
                                    <th>Weath Price APL</th>
                                    <th>Weath Price BPL</th>
                                    <th>Edit</th>
                                    <th>Delete</th>
                                  </tr>
    
                            <?php
                              $sql = "(SELECT `id`,`ricepriceapl`, `ricepricebpl`, `sugarpriceapl`, `sugarpricebpl`,
                              `weathpriceapl`,`weathpricbpl` FROM `price`)";
                          ...
                          <tr>
                            <td> <?php echo $row['ricepriceapl']; ?> </td>
                            <td> <?php echo $row['ricepricebpl']; ?> </td>
                            <td> <?php echo $row['sugarpriceapl']; ?> </td>
                            <td> <?php echo $row['sugarpricebpl']; ?> </td>
                            <td> <?php echo $row['weathpriceapl']; ?> </td>
                            <td> <?php echo $row['weathpricbpl']; ?> </td>
                            <td> <a href="editprice.php?id=<?php echo $row['id']; ?>"> <i class="fa fa-pencil-square" aria-hidden="true"></i>  </td>
                            <td> <a href="deleteprice.php?id=<?php echo $row['id']; ?>"><i class="fa fa-trash" aria-hidden="true"></i> </td>
