           ...
           <section>
                <div class="row">
                  ...
                  <div class="col-md-8" style="">
                          ...
                          <div class="col-md-9">
                            <h1><i class="fa fa-registered" aria-hidden="true"></i> REGISTER DEALERS </h1><hr>
                            <ol class="breadcrumb">
                                <li><a href="adminmain.php"><i class="fa fa-tachometer" aria-hidden="true"></i> ADMIN PANEL</a></li>
                              <li class="active"> <i class="fa fa-registered" aria-hidden="true"></i> REGISTER DEALERS </li>
                            </ol>

                            <div class="form-reg">
                              <h2 align="center"> <i class="fa fa-registered" aria-hidden="true"></i> DEALER REGISTER</h2><hr>
              
                                <form action="" method="POST">
                                        <div class="form-group">
                                              <label for="nam">Name:</label>
                                              <input type="text" class="form-control" name="nam"  autocomplete="off" required>
                                        </div>
              
                                            <div class="form-group">
                                                  <label for="parentage">PARENTAGE:</label>
                                                  <input type="text" class="form-control" name="parentage" autocomplete="off" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                  ...
                                                  <input type="text" class="form-control" name="adress" autocomplete="off" required>
                                          </div>
              
                                                <div class="form-group">
                                                      <label for="licenceno">Licence no:</label>
                                                      <input type="text" class="form-control" name="licenceno" autocomplete="off" required>
                                              </div>

                                                    <div class="form-group">
                                                      <label for="ocode">shop code:</label>
                                                      <input type="text" class="form-control" name="ocode" autocomplete="off" required>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                              ...
                                                              <hr>                
                                  <button type="submit" class="btn btn-sucess" name="submit">REGISTER</button>
                                </form>
                              ...
                              <?Php
                                  ...
                                  if(isset($_POST['submit']))
                                  {
                                    ...
                                    $repass =$_POST['repass'];
                                        ...
                                        $sql= "INSERT INTO register (nam, parentage,mobileno,adress,licenceno,ocode,user,pass,repass) 
                                    VALUES('$nam','$parentage','$mobileno','$adress','$licenceno','$ocode','$user','$pass','$repass')";
                                    $query= mysqli_query($con,$sql); 
                                  
                                    if($query){

                                      echo"<script>window.alert(\"register dealer sucessfully\");</script>";
                                      echo"register dealer sucessfully";
