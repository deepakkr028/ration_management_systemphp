...
<html lang="en">
  ...
  <body>
     ...
     <div class="jumbotron">
        <div class="container">
          <div id="head">
            <h1 align="center"><b>RATION HOLDER STOCK DETAILS</b></h1>
            </div>
          </div>
     </div> 
     ...
     <section>
         <div class="container">
             <div class="row">
                ...
                <div class="search" style="margin-left:50px; margin-bottom:5px;">
                          ...
                          ?>
                                ...
                                <tr>
                                 <td> <?php echo $row['id'];  ?> </td>
                                  ...
                                  <td> <?php echo $row['ricewt']; ?> </td>
                                  <td> <?php echo $row['floarwt']; ?> </td>
                                  <td> <?php echo $row['sugarwt']; ?> </td>
                                  <td> <?php echo $row['riceprice']; ?> </td>
                                  <td> <?php echo $row['floarprice']; ?> </td>
                                  <td> <?php echo $row['sugarprice']; ?> </td>
                      ...
                      <table class="table table-bordered table-striped table-hover" style=""
                          <tr border=4px;>
                             <th>S.NO</th>
                              ...
                              <th>card type</th>
                              <th> get Ration Detais </th>
                              <th>rice weight(/kg)</th>
                              <th>flour weight(/kg)</th>
                              <th> Sugar weight(/kg) </th>
                              <th> Rice price</th>
                              <th>flour Price</th>
                              <th>sugar price </th>
                             <th> Total </th>
